...
[image]:https://rafalab.github.io/dsbook/book_files/figure-html/state-region-distribution-1.png 
...
Statistics textbooks teach us that a more useful way to define a distribution for numeric data is to define a function that reports the proportion of the data below  $$a$$ for all possible values of $$a$$
 . This function is called the cumulative distribution function (CDF). In statistics, the following notation is used: $$F(a)=Pr(x≤a)$$
...
![][image2]
[image2]:https://rafalab.github.io/dsbook/book_files/figure-html/height-histogram-1.png 
...
![][image3]
[image3]:https://rafalab.github.io/dsbook/book_files/figure-html/example-of-smoothed-density-1.png 
...
[image4]:https://rafalab.github.io/dsbook/book_files/figure-html/simulated-data-histogram-1-1.png

The smaller we make the bins, the smoother the histogram gets. Here are the histograms with bin width of 1, 0.5, and 0.1:

![][image5]

[image5]:https://rafalab.github.io/dsbook/book_files/figure-html/simulated-data-histogram-2-1.png
...
![][image8]
[image8]:https://rafalab.github.io/dsbook/book_files/figure-html/simulated-density-1-1.png
...
![][image7]
[image7]:https://rafalab.github.io/dsbook/book_files/figure-html/smooth-density-2-1.png
...
![][image6]
[image6]:https://rafalab.github.io/dsbook/book_files/figure-html/densities-different-smoothness-1.png
...
![][image9]
[image9]:https://rafalab.github.io/dsbook/book_files/figure-html/area-under-curve-1.png
...
![][image10]
[image10]:https://rafalab.github.io/dsbook/book_files/figure-html/example-of-smoothed-density-2-1.png
...
![][image11]
[image11]:https://rafalab.github.io/dsbook/book_files/figure-html/two-densities-one-plot-1.png
...
![][image12]
[image12]:https://rafalab.github.io/dsbook/book_files/figure-html/barplot-exercise-1.png
...
![][image12]
[image12]:https://rafalab.github.io/dsbook/book_files/figure-html/ecdf-exercise-1.png
...
![][image14]
[image14]:https://rafalab.github.io/dsbook/book_files/figure-html/ecdf-exercise-2-1.png
...
![][iamge15]
[iamge15]:https://rafalab.github.io/dsbook/book_files/figure-html/height-histogram-exercise-1.png
...
![][image17]
[image17]:https://rafalab.github.io/dsbook/book_files/figure-html/density-exercise-1.png
a. 0.02
b. 0.15
c. 0.50
d. 0.55
...
![][image18]
[image18]:https://rafalab.github.io/dsbook/book_files/figure-html/density-exercise-2-1.png
...
a  and b , and known mathematical constants  
...
![][image19]
[image19]:https://rafalab.github.io/dsbook/book_files/figure-html/normal-distribution-density-1.png
...
![][image20]
[image20]:https://rafalab.github.io/dsbook/book_files/figure-html/data-and-normal-densities-1.png
...
Φ−1(x)  gives us the theoretical quantiles for the normal distribution. So, for example,  Φ−1(0.975)=1.96 . In R, we can evaluate the inverse of  Φ  using the qnorm function.
...
![][image21]
[image21]:https://rafalab.github.io/dsbook/book_files/figure-html/hist-qqplot-non-normal-data-1.png
...
![][image22]
[image22]:https://rafalab.github.io/dsbook/book_files/figure-html/first-boxplot-1.png
...
![][image23]
[image23]:https://rafalab.github.io/dsbook/book_files/figure-html/female-male-boxplots-1.png
...
![][image24]
[image24]:https://rafalab.github.io/dsbook/book_files/figure-html/histogram-qqplot-female-heights-1.png
...
![][image25]
[image25]:https://rafalab.github.io/dsbook/book_files/figure-html/boxplot-exercise-1.png
...
```{r}
heights %>% filter(sex == "Female") %>%
  ggplot(aes(height))+ geom_histogram(binwidth = 1, fill = "blue", col ="black") +
...
![][image26]
[image26]:https://rafalab.github.io/dsbook/book_files/figure-html/female-male-boxplots-geom-1.png
...
```{r}
heights %>% filter(sex == "Male") %>% ggplot(aes(height))  + geom_density(fill = "blue")
heights %>% filter(sex == "Female") %>% ggplot(aes(height)) + geom_density(fill = "red")
```
